    ...
    <section className="max-w-4xl mx-auto px-4 py-2 -mt-4">
      ...
      >
        ...
        <div className="relative text-center max-w-2xl mx-auto">
          {/* SMALL LINE */}
          <p
            className={`reveal ${show ? "show" : ""} text-[11px] uppercase tracking-[0.35em] text-gray-400 mb-1`}
          >
            Founder
          </p>
          ...
          {/* NAME */}
          <h2
            className={`reveal d-100 ${show ? "show" : ""} text-3xl md:text-4xl font-bold text-white mb-2`}
          >
          ...
          <p
            className={`reveal d-300 ${show ? "show" : ""} mt-2 text-gray-300 text-sm md:text-base leading-relaxed`}
          >
            My focus is simple:{" "}
            <span className="text-green-300">
              clean UI, reliable delivery, clear communication
            </span>
            .
          </p>
          ...
          {/* QUOTE */}
          <p
            className={`reveal d-400 ${show ? "show" : ""} mt-4 text-xs text-gray-400 italic`}
          >
            “Build simple. Launch fast. Improve with real feedback.”
          </p>
        </div>
      </div>
    </section>
